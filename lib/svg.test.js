...
test("should append text element", () => {
  const expectedSvg =
    '<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect x=\"90\" y=\"40\" width=\"120\" height=\"120\" fill=\"\" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="white">A</text></svg>';
  const svg = new SVG();
...
test("should set text message and color", () => {
  const expectedSvg =
    '<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect x=\"90\" y=\"40\" width=\"120\" height=\"120\" fill=\"\" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="#333">SVG</text></svg>';
  const svg = new SVG();
  svg.setShape(new Square());
  svg.setText("SVG", "#333");
  expect(svg.render()).toEqual(expectedSvg);
